        ...
        {showSqlModal && (
            <div className="absolute inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                <div className="bg-zinc-900 border-2 border-red-500 p-4 md:p-6 rounded-lg max-w-lg w-full shadow-2xl overflow-y-auto max-h-[80vh] flex flex-col">
                    <h3 className="text-red-500 font-bold mb-3 font-press-start text-xs md:text-sm text-center">SETUP REQUIRED</h3>
                    <p className="text-zinc-300 text-[10px] md:text-xs mb-3 font-sans text-center">
                        The <code>scores</code> table is missing. Run this SQL in your Supabase Editor:
                    </p>
